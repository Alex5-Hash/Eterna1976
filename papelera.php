...
if (isset($_GET['restore_id'])) {
    ...
    if ($row) {
        ...
        // Verificamos el pa�s para decidir a qu� tabla insertar
        if ($Pais === 'HN') {
            ...
            // Por ejemplo, puedes omitir la inserci�n o guardar en una tabla diferente
            header("Location: papelera.php");
            exit();
        }
...
<body>
    ...
    <div class="pagination">
        ...
        <?php if ($page < $total_pages): ?>
            ...
            <a href="?page=<?php echo $total_pages; ?>&limit=<?php echo $limit; ?>">�ltimo</a>
        <?php endif; ?>
    </div>
